...
from report_modules.parsers.genometools_gt_stat_parser import parse_genometools_gt_stat_folder
...
if __name__ == "__main__":
    ...
    data_from_tools = {**data_from_tools, **{"VERSIONS": {"SELF":"v0.7", "NCBI_FCS_ADAPTOR": "0.4", "ASSEMBLATHON_STATS": "160b94c", "GENOMETOOLS_GT_STAT": "1.6.2", "BUSCO": "5.2.2", "TIDK": "0.2.31", "LAI": "2.9.0", "KRAKEN2": "2.1.2"}}}
